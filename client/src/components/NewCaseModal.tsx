            ...
            <ScrollArea className="max-h-[55vh] pr-4">
              <div className="space-y-6 py-4">
                ...
                {formData.category === "provider" && (
                  <ProviderFields formData={formData} updateField={updateField} toggleArrayField={toggleArrayField} />
                )}
                {formData.category === "billing" && (
                  <BillingFields formData={formData} updateField={updateField} toggleArrayField={toggleArrayField} />
                )}
                {formData.category === "medication" && (
                  <MedicationFields formData={formData} updateField={updateField} toggleArrayField={toggleArrayField} />
                )}
                {formData.category === "service" && (
                  <ServiceFields formData={formData} updateField={updateField} />
                )}
                ...
                {formData.category === "plan" && (
                  <PlanFields formData={formData} updateField={updateField} toggleArrayField={toggleArrayField} />
                )}
                ...
                <CommunicationPreferences formData={formData} updateField={updateField} toggleArrayField={toggleArrayField} />
              </div>
            </ScrollArea>
